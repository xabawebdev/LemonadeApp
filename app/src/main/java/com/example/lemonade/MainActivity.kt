...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        if (lemonadeState == SELECT) {
            ...
            stateImage.setImageResource(R.drawable.lemon_tree)
        } else if (lemonadeState == SQUEEZE) {
            textAction.setText(R.string.lemon_squeeze)
            stateImage.setImageResource(R.drawable.lemon_squeeze)
        } else if (lemonadeState == DRINK) {
            textAction.setText(R.string.lemon_drink)
            stateImage.setImageResource(R.drawable.lemon_drink)
        } else {
            textAction.setText(R.string.lemon_empty_glass)
            stateImage.setImageResource(R.drawable.lemon_restart)
